...
<intent-filter>
    ...
    <data android:scheme="com.ionicdemo.otpless.otpless" android:host="otpless"/> <!-- Update the Application Id-->
</intent-filter>
```
...
<array>
    ...
    <array>
    <string>com.ionicdemo.otpless.otpless</string> <!-- Update the PRODUCT_BUNDLE_IDENTIFIER -->
    </array>
...
[Check out function](https://github.com/devbathaniotpless/otpless-ionic-demo/blob/login-uri-override-demo/src/pages/Home.tsx#L14)
